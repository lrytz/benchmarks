 ...
 *
 * sbt clean 'set scalaVersion := "2.11.7"' 'set scalacOptions in ThisBuild ++= Seq("-Ybackend:GenBCode")' 'run -f 1 -i 20 -wi 20 -t 1 DeltaBlue'
 * [info] DeltaBlue.bench1  avgt   20  0.043 ±  0.001  ms/op
 * [info] DeltaBlue.bench2  avgt   20  0.046 ±  0.002  ms/op
 *
 * sbt clean 'set scalaVersion := "2.11.7"' 'set scalacOptions in ThisBuild ++= Seq("-optimise")' 'run -f 1 -i 20 -wi 20 -t 1 DeltaBlue'
 * [info] DeltaBlue.bench1  avgt   20  0.044 ±  0.001  ms/op
 * [info] DeltaBlue.bench2  avgt   20  0.042 ±  0.001  ms/op
 *
 * sbt clean 'set scalaVersion := "2.12.0-newopt"' 'run -f 1 -i 20 -wi 20 -t 1 DeltaBlue'
 * [info] DeltaBlue.bench1  avgt   20  0.042 ±  0.001  ms/op
 * [info] DeltaBlue.bench2  avgt   20  0.048 ±  0.001  ms/op
 *
 * sbt clean 'set scalaVersion := "2.12.0-newopt"' 'set scalacOptions in ThisBuild ++= Seq("-Yopt:l:classpath")' 'run -f 1 -i 20 -wi 20 -t 1 DeltaBlue'
