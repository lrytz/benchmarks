 ...
 * My machine
 * ----------
 * sbt clean 'set scalaVersion := "2.11.7"' 'jmh:run -f 1 -i 20 -wi 20 -t 1 DeltaBlue'
 * [info] DeltaBlue.bench1  avgt   20  0.047 ±  0.001  ms/op
 * [info] DeltaBlue.bench2  avgt   20  0.045 ±  0.001  ms/op
 *
 * sbt clean 'set scalaVersion := "2.11.7"' 'set scalacOptions in ThisBuild ++= Seq("-Ybackend:GenBCode")' 'jmh:run -f 1 -i 20 -wi 20 -t 1 DeltaBlue'
 * [info] DeltaBlue.bench1  avgt   20  0.043 ±  0.001  ms/op
 * [info] DeltaBlue.bench2  avgt   20  0.046 ±  0.002  ms/op
 *
 * sbt clean 'set scalaVersion := "2.11.7"' 'set scalacOptions in ThisBuild ++= Seq("-optimise")' 'jmh:run -f 1 -i 20 -wi 20 -t 1 DeltaBlue'
 * [info] DeltaBlue.bench1  avgt   20  0.044 ±  0.001  ms/op
 * [info] DeltaBlue.bench2  avgt   20  0.042 ±  0.001  ms/op
 *
 * sbt clean 'set scalaVersion := "2.12.0-newopt"' 'jmh:run -f 1 -i 20 -wi 20 -t 1 DeltaBlue'
 * [info] DeltaBlue.bench1  avgt   20  0.042 ±  0.001  ms/op
 * [info] DeltaBlue.bench2  avgt   20  0.048 ±  0.001  ms/op
 *
 * sbt clean 'set scalaVersion := "2.12.0-newopt"' 'set scalacOptions in ThisBuild ++= Seq("-Yopt:l:classpath")' 'jmh:run -f 1 -i 20 -wi 20 -t 1 DeltaBlue'
 * [info] DeltaBlue.bench1  avgt   20  0.041 ±  0.001  ms/op
 * [info] DeltaBlue.bench2  avgt   20  0.043 ±  0.001  ms/op
 */
...
class DeltaBlue {
  ...
  @Benchmark
  def bench1(): Unit = chainTest(100)

  @Benchmark
  def bench2(): Unit = projectionTest(100)
}
